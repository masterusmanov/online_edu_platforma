    ...
    return(
       <div className="">
            ...
            <div className="max-h-screen overflow-y-auto">
                <div className="m-5 p-5 bg-white rounded-md lg:flex justify-start items-center lg:gap-[50px] xl:justify-between">
                    <div className="grid md:flex lg:items-center xl:items-start gap-4">
                        <img src={savodxon} alt="" className="w-[200px] md:w-[150px] mx-auto"/>
                        <div className="md:px-5">
                            <h1 className="font-[700] text-[18px] my-[20px] 2xl:text-[22px]">Kompyuter savodxonligi kursi</h1>
                    ...
                    <div className="grid gap-4 mt-[15px] md:flex items-center justify-between lg:grid xl:gap-6 xl:pr-5">
                        <div className="flex justify-between items-center gap-6 xl:gap-[70px]">
                    ...
                    <div className=" grid justify-center md:flex flex-wrap gap-4 mt-[20px] overflow-y-auto md:max-h-[43.5vh] lg:max-h-[25.5vh] xl:max-h-[38vh] 2xl:max-h-[50vh] xl:justify-start 2xl:gap-2">
                        {cards.map(item => (
                            ...
                            <div className="my-[20px] w-[250px] md:w-[200px] border grid gap-4 bg-[#F7F7F5] p-3 rounded-lg lg:w-[250px] xl:w-[220px] 2xl:w-[300px] hover:shadow-xl hover:shadow-gray-500">
                                <img src={item.img} alt="" className="rounded-lg w-[200px] md:w-[150px] md:h-[150px] xl:w-full 2xl:h-[250px] mx-auto xl:p-5 2xl:p-10"/>
                                <div>
